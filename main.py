...
# from parsers.user import parse_user_page
...
# parse_user_page('https://vk.com/id53083705')
# parse_group_page('https://vk.com/public43618728')
...
# parse_user_wall('https://vk.com/dm?offset=5&amp;own=20#posts')
